...
final class MinifigureIdentificationService: ObservableObject {
    ...
    func identify(torsoImage: UIImage) async throws -> [ResolvedCandidate] {
        ...
        // ── Phase 1.5: DINOv2 Embedding Retrieval ──
        //
        // Merge color-cascade results with hits from the DINOv2-based
        // torso/face embedding retrievers. The bundled embeddings were
        // generated by Meta's DINOv2 ViT-S/14 (384-D, zero-shot) and
        // the on-device CoreML encoder produces matching embeddings at
