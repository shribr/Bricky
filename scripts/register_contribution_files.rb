...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'ContributionUploadQueue.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'ContributionUploadQueueTests.swift')
