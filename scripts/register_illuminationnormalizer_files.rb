...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'IlluminationNormalizer.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'IlluminationNormalizerTests.swift')
