...
add_source(app_target, group_at(project, ['Bricky', 'ViewModels']), 'ScanBrickViewModel.swift')
add_source(app_target, group_at(project, ['Bricky', 'ViewModels']), 'RebuildableSetsViewModel.swift')
add_source(app_target, group_at(project, ['Bricky', 'Views']), 'ScanBrickView.swift')
add_source(app_target, group_at(project, ['Bricky', 'Views']), 'RebuildableSetsView.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'ScanBrickViewModelTests.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'RebuildableSetsViewModelTests.swift')
