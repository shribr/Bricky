...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'CorrectionIndexService.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'CorrectionIndexServiceTests.swift')
