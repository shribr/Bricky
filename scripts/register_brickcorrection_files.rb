...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'BrickCorrectionStore.swift')
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'BrickCorrectionReranker.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'BrickCorrectionStoreTests.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'BrickCorrectionRerankerTests.swift')
