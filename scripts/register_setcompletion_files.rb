...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'SetCompletionEngine.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'SetCompletionEngineTests.swift')
