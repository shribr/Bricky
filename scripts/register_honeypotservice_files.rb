...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'HoneypotService.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'HoneypotServiceTests.swift')
