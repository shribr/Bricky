...
add_source(app_target, group_at(project, ['Bricky', 'Services']), 'BrickInstanceTracker.swift')
add_source(app_target, group_at(project, ['Bricky', 'Views']), 'TrackedBrickOverlayView.swift')
add_source(test_target, group_at(project, ['BrickyTests']), 'BrickInstanceTrackerTests.swift')
